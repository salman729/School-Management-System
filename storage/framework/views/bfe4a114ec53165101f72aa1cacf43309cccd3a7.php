<?php $__env->startSection('title','Days'); ?>
...
<div class="panel-body">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3>Add Day</h3>
            <form role="form" method="post" action="<?php echo e(url('addDays')); ?>">
             <?php echo e(csrf_field()); ?>
                ...
                <div class="col-md-4"> 
                    ...
                    <input name="day_name" class="form-control" required="required" placeholder="Enter Day Name">
                    </div>
                    <!--<div class="form-group">
