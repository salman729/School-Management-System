           ...
           <div class="table-responsive">
             <table class="table table-striped table-bordered table-hover" id="dataTables-example">
              ...
              <td><?php echo e($reg->session->s_name); ?></td>
							<td><a href="<?php echo e(url('viewProfile/'.$reg->id)); ?>">View profile</a></td>
							<td><a href="<?php echo e(url('editRegistration/'.$reg->id)); ?>"><i class="fa fa-edit"></i></a> <a href="<?php echo e(url('delRegistration/'.$reg->id)); ?>"><i class="fa fa-trash"></i></a>
              </td>
						</tr>
