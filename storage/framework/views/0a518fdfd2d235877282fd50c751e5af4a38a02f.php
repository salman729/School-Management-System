...
<div class="panel-body">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3>Add Category</h3>
            <form role="form" method="post" action="<?php echo e(url('addCategories')); ?>">
             <?php echo e(csrf_field()); ?>
                ...
                <div class="col-md-4"> 
                    ...
                    <input name="cat_name" class="form-control" required="required" placeholder="Enter Category Name">
                    </div>
                    <!--<div class="form-group">
