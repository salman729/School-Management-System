...
<?php $__env->startSection('content'); ?>
    ...
    <strong>Success</strong> Attendance Marked Successfully
             ...
             <div class="table-responsive">
              <input type="hidden" name="peroid_id" id="peroid_id" value="<?php echo e(Request::segment(3)); ?>">
...
console.log(mydata);
    ...
    type:"POST",
    dataType:'JSON',
   data:{mydata:mydata,peroid_Id:peroid_id,attenDenceDate:attendenceDate,_token:"<?php echo e(csrf_token()); ?>"},
...
window.location.href ='<?php echo e(url('timeTable-list')); ?>';
}
    }
  });
