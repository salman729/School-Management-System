<?php $__env->startSection('title','Exam Slot'); ?>
...
<div class="panel-body">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3>Add Exam Slot</h3>
            <form role="form" method="post" action="<?php echo e(url('addExamSlot')); ?>">
             <?php echo e(csrf_field()); ?>
                ...
                <div class="col-md-4">
                    ...
                    <select custom class="form-control" name="examTime_id" required="required">
                        ...
                        <option value="<?php echo e($examTime->id); ?>"><?php echo e($examTime->examTimeName); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    </div>
